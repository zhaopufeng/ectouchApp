/*! Zepto 1.1.6 (generated with Zepto Builder) - zepto event ajax ajax ajax ajax touch selector ajax assets callbacks data form detect deferred fx fx_methods gesture ie stack ios3 - zeptojs.com/license */
var Zepto = function() {
    function t(t) {
    ...
    function h(t) {
        var e, n;
        return D[t] || (e = k.createElement(t), k.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), D[t] = n),
        D[t]
    }
    function p(t) {
        return "children" in t ? M.call(t.children) : S.map(t.childNodes,
        function(t) {
    ...
    function x(t, e) {
        e(t);
        for (var n = 0,
        i = t.childNodes.length; i > n; n++) x(t.childNodes[n], e)
    }
    var T, E, S, j, C, O, P = [],
    A = P.concat,
    N = P.filter,
    ...
    G.fragment = function(t, e, n) {
        var i, r, a;
        return F.test(t) && (i = S(k.createElement(RegExp.$1))),
        i || (t.replace && (t = t.replace(R, "<$1></$2>")), e === T && (e = $.test(t) && RegExp.$1), e in V || (e = "*"), a = V[e], a.innerHTML = "" + t, i = S.each(M.call(a.childNodes),
        function() {
            a.removeChild(this)
        })),
        o(n) && (r = S(i), S.each(n,
    ...
    G.init = function(t, n) {
        var i;
        if (!t) return G.Z();
        if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && $.test(t)) i = G.fragment(t, RegExp.$1, n),
        t = null;
        else {
            ...
            t = null;
            else if ($.test(t)) i = G.fragment(t.trim(), RegExp.$1, n),
            t = null;
            else {
                if (n !== T) return S(n).find(t);
                i = G.qsa(k, t)
    ...
    S.fn = {
        ...
        ready: function(t) {
            return H.test(k.readyState) && k.body ? t(S) : k.addEventListener("DOMContentLoaded",
            function() {
                t(S)
            },
            !1),
        ...
        filter: function(t) {
            return e(t) ? this.not(this.not(t)) : S(N.call(this,
            function(e) {
        ...
        toggleClass: function(t, e) {
            return t ? this.each(function(n) {
                var i = S(this),
                r = v(this, t, n, b(this));
                r.split(/\s+/g).forEach(function(t) { (e === T ? !i.hasClass(t) : e) ? i.addClass(t) : i.removeClass(t)
                })
            }) : this
        },
...
function(t) {
    ...
    function l(t) {
        ...
        t && (t == E ? "html": t == T ? "json": w.test(t) ? "script": x.test(t) && "xml") || "text"
    }
    function f(t, e) {
    ...
    t.ajax = function(e) {
        ...
        i(u),
        u.crossDomain || (n = y.createElement("a"), n.href = u.url, n.href = n.href, u.crossDomain = j.protocol + "//" + j.host != n.protocol + "//" + n.host),
...
function(t) {
    function e(t, e) {
        ...
        j = S || t.match(/Version\/([\d.]+)([^S](Safari)|[^M]*(Mobile)[^S]*(Safari))/); (i.webkit = !!r) && (i.version = r[1]),
        ...
        j && (a || n.ios || f) && (i.safari = !0, n.ios || (i.version = j[1])),
        S && (i.webview = !0),
        n.tablet = !!(s || b || o && !t.match(/Mobile/) || x && t.match(/Tablet/) || E && !t.match(/Phone/) && t.match(/Touch/)),
        n.phone = !(n.tablet || n.ipod || !(o || c || l || g || v || w && t.match(/Android/) || w && t.match(/CriOS\/([\d.]+)/) || x && t.match(/Mobile/) || E && t.match(/Touch/)))
    }
...
function(t, e) {
    ...
    t.fn.anim = function(i, r, d, m, g) {
        ...
        C = !1;
        if (r === e && (r = t.fx.speeds._default / 1e3), g === e && (g = 0), t.fx.off && (r = 0), "string" == typeof i) T[l] = i,
        T[f] = r + "s",
        T[p] = g + "s",
        T[h] = d || "linear",
        j = t.fx.animationEnd;
            ...
            E && (T[o] = E, w.push(o)),
            r > 0 && "object" == typeof i && (T[a] = w.join(", "), T[s] = r + "s", T[c] = g + "s", T[u] = d || "linear")
        }
        return x = function(e) {
...
function(t) {
    ...
    t(document).ready(function() {
        ...
        function(t) { (!(v = a(t, "move")) || o(t)) && (g = v ? t: t.touches[0], i(), h.x2 = g.pageX, h.y2 = g.pageY, y += Math.abs(h.x1 - h.x2), b += Math.abs(h.y1 - h.y2))
        }).on("touchend MSPointerUp pointerup",
        function(n) { (!(v = a(n, "up")) || o(n)) && (i(), h.x2 && Math.abs(h.x1 - h.x2) > 30 || h.y2 && Math.abs(h.y1 - h.y2) > 30 ? c = setTimeout(function() {
                h.el.trigger("swipe"),
